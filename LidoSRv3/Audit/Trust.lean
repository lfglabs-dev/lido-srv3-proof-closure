...
-- General rule (Thomas 2026-09-12) applied to P-TOPUP-1 three booleans:
-- naming scaffold PinnedSRTopupCallShape that names the three pinned SR
-- reads explicitly. Full derivation from live SR storage remains an
-- open follow-up disclosed in fidelity.missing.
...
-- Lido.sol:872 Aragon-ACL check. Full live-storage derivation is the
...
-- Thirty-first-step (2026-09-13): TOPUP-1 D-CALL-1 two-argument withdraw shape.
#print axioms LidoSRv3.Audit.Source.TopupWithdrawTwoArgSource.withdrawArgs_length
#print axioms LidoSRv3.Audit.Source.TopupWithdrawTwoArgSource.withdrawArgs_first
#print axioms LidoSRv3.Audit.Source.TopupWithdrawTwoArgSource.withdrawArgs_second
-- Thirty-second-step (2026-09-13): RESERVE-1 D-TRANSFER-1 payable-CALL source model.
...
-- Forty-second-step (2026-09-13): P-TOPUP-1 SR module packed-decoder source model (item a).
...
-- Structural SSZ wrappers: foundational axiom lists do not discharge the
-- model's digest-oracle correspondence. A-SHA256-FFI remains assumed.
