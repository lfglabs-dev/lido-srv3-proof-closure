...
namespace LidoSRv3.Audit.Source.TopupPipelineMinimalLedger
...
theorem positive_effects_conservation (hash : TopupRouterCredentials.Keccak)
  ...
  obtain ⟨hfunds,hledger⟩ :=
    audit.trio.deposit.WithdrawalLedgerMinimal.pipeline_withdrawal_success_ledger
...
end LidoSRv3.Audit.Source.TopupPipelineMinimalLedger
