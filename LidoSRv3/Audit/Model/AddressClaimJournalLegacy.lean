/-
Historical journal executor retained from integrated proof commit
14a96a3180ac9fb81f853db36af3b630c1d5891f. All executable definitions and
proofs below are preserved modulo the namespace. Historical comments describe
that model: its mapUint channels and externalCallBindTo journal are not the
new physical-storage / recipient-callback executor. The actual P-ADDRESS-1
consumers import Verity.AddressClaimBatchTx and AddressRecipientCallBridge.
-/
...
namespace LidoSRv3.Audit.Model.AddressClaimJournalLegacy
...
end LidoSRv3.Audit.Model.AddressClaimJournalLegacy
