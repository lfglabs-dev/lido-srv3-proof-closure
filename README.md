...
> - **Every row below still has open fidelity gaps — 103 in total.** The last
...
| 3 | `P-DEPOSIT-1` | CHECKED | CHECKED — composed finite list-batch executable transaction | 9 open |
