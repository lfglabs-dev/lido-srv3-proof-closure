...
| 4 | `P-TOPUP-1` | `LidoSRv3.Audit.Guarantees.PTopup1.parent_verity_transaction_closure` |
...
applicable.
P-ADDRESS-1 closes the caller-renaming relation through a single-item
pinned-source-shaped interpreter and an official Verity `Contract.run`
transaction classification. Batch iteration, non-address arithmetic, and
external results remain explicit at the source boundary; generated Yul,
bytecode, deployed runtime, and EVM execution remain open.
