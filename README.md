...
> - **Every row below still has open fidelity gaps — 60 in total.** The last
...
| 3 | `P-DEPOSIT-1` | CHECKED | CHECKED — composed finite list-batch executable transaction | 3 open |
| 4 | `P-TOPUP-1` | CHECKED | CHECKED | 1 open |
| 5 | `P-ACCOUNT-1` | CHECKED | CHECKED | 5 open |
| 6 | `P-RESERVE-1` | CHECKED | CHECKED | 6 open |
| 7 | `P-CONSOLIDATION-ETH-1` | CHECKED | CHECKED | 11 open |
| 8 | `P-ADDRESS-1` | CHECKED | CHECKED | 7 open |
