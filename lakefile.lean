...
lean_lib «AccountAddressChecks» where
  ...
  roots := #[`PAccount1, `ReportWriteFee, `StETHMintShares, `ReportFeeMint, `ReportFeeCastInvariant, `ReportFeeCheckedSplit, `FeeDistribution, `ReportFeeDistribution, `PAddress1, `PAddress1Physical,
    ...
    `Tests.Verity.ReportFeeDistributionTest,
