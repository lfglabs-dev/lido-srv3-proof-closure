...
lean_lib «AccountAddressChecks» where
  ...
  roots := #[`PAccount1, `ReportWriteFee, `StETHMintShares, `ReportFeeMint, `ReportFeeCastInvariant, `ReportFeeCheckedSplit, `FeeDistribution, `ReportFeeDistribution, `TreasuryCall, `ReportFeeTreasuryCall, `ReportFeePhysicalPause, `PAddress1, `PAddress1Physical,
