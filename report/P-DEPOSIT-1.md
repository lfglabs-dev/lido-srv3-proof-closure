...
Theorems: `PDeposit1.source_deposit_conserves_and_rolls_back` (registered abstract parent), `PDeposit1.verity_tx_composes_deposit_conservation_and_rollback` (Verity composition), `PDeposit1.linked_deployment_push_is_word_bounded`, `PDeposit1.linked_conserving_deployment_pull_is_word_bounded` and `PDeposit1.abstract_parent_covers_deployments_the_verity_plane_omits` with `PDeposit1.oversized_run_commits` (checked statement of the finite executable scope and of the deployments it omits), `PDeposit1.linked_hypotheses_do_not_bound_the_source_pull` (pull kill-line), `DepositVectors.dropped_conservation_assert_breaks_pulled_eq_pushed` (kill-line).
