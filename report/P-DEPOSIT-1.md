...
- An arbitrary withdrawal callback need not implement Lido. The parent proves its actual call/result continuation. Existing physical-ledger conservation consumers need their explicit locator/role hypotheses; unconditional deployed conservation is not claimed.
