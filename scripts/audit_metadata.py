...
faithful Verity theorem (or honest partial state), and one actionable gap class.
...
PINNED = {
    ...
    "verity": ("https://github.com/lfglabs-dev/verity.git", "04729a9de9099e065dd09283e4f733a5fd4c2a16"),
...
EXPECTED_CANONICAL_DETAIL_SHA256 = {
    ...
    "P-DEPOSIT-1": "9119f568b7df6e0828500cbf26bb8e602b5aad8f7fa308f44dabcd399abb5997",
    "P-TOPUP-1": "b991c46472880eea28fa70a24306f1ffba3f87a696f8f434c593a70a4b914970",
    ...
    "P-ADDRESS-1": "4bc8262f93616bc0221e3c531d0e420321522630dc0379b35afdec6a20785b6c",
    "P-TOPUP-2": "9621daf2db8ef7a5fee32ff3d03699c2e592970ad77fba98a20c0032c5143d87",
    "P-CONSOLIDATION-1": "2c21041fda99844453f05e0c44723488c1bb8c7a215d501a6e31b6b855944f10",
...
def rendered(rows):
    ...
    labels = {
        "P1": "P1 — restore retracted faithful Verity paths",
        "P2": "P2 — complete partial/open guarantees",
        "P3": "P3 — SSZ closure and targeted Yul binding",
    ...
    lines = ["# STATUS", "", "| ID | Abstract Lean | Verity | Fidelity gap | Classification | Assumptions |", "| --- | --- | --- | --- | --- | --- |"]
    for r in canonical:
