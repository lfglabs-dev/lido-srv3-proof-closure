...
EXPECTED_WORDING = [
    ...
    "Per-validator top-up headroom and aggregate budget conservation are proved on an abstract model; verifier-binding (SSZ proof that the accepted proof binds the intended validator) remains BLOCKED on runtime provenance.",
...
EXPECTED_REPRODUCTION = [
    ...
    {"command": "lake build LidoSRv3.Audit.Guarantees.PTopup2",
     "expected": "successful abstract per-validator headroom and aggregate budget conservation build; verifier-binding remains blocked on runtime provenance"},
...
EXPECTED_THEOREMS = [
    ...
    "LidoSRv3.Audit.Guarantees.PTopup2.topup_batch_sound",
    None,
