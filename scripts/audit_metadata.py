...
EXPECTED_MANIFEST_THEOREMS = [
    ...
    {"name": "Guarantees.PAlloc1.checked_uint256_execution_refines_math", "status": "lean_checked",
     "axioms": ["propext"]},
    {"name": "SolidityMinFirst.run_conservation_capacity_disabled",
     "status": "lean_checked", "axioms": []},
    {"name": "SolidityMinFirst.conservation_mutant_rejected",
     "status": "lean_checked", "axioms": []},
    {"name": "SolidityMinFirst.capacity_mutant_rejected",
     "status": "lean_checked", "axioms": []},
    {"name": "SolidityMinFirst.disabled_module_mutant_rejected",
     "status": "lean_checked", "axioms": []},
