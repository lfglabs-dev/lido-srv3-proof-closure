...
EXPECTED_NEXT_GATES = [
    ...
    "Refine success/revert and rollback against pinned executable EVM semantics. The abstract transaction observation theorem lives in the model plane; tx-plane requires Verity execution simulation.",
    "Refine top-up success/revert and rollback against pinned executable EVM semantics, and prove allocation extraction from pinned Solidity. The abstract transaction observation theorem lives in the model plane; tx-plane requires Verity execution simulation.",
    ...
    "Build a mutant-sensitive Yul interface harness at the exact EVMYulLean pin. The abstract transaction observation theorem lives in the model plane; tx-plane requires Verity execution simulation.",
    ...
    "Promote the abstract digest layer only after Verity execution simulation connects the typed statement program to precompile denotation; SHA-256 functional correctness and production runtime provenance remain assumptions. The abstract transaction observation theorem lives in the model plane; tx-plane requires Verity execution simulation.",
    "Refine the typed 96-byte single-call program against generated Yul/EVM semantics and independently verified production runtime provenance. The abstract transaction observation theorem lives in the model plane; tx-plane requires Verity execution simulation.",
    "Refine the composed checked SRLib/MinFirst operator-bound evidence against executable EVM semantics.",
    "Independent Yul/EVM interface proof beyond this harness; runtime/production provenance and full EVM equivalence remain open. The abstract transaction observation theorem lives in the model plane; tx-plane requires Verity execution simulation.",
...
EXPECTED_MANIFEST_THEOREMS = [
    ...
    {"name": "Guarantees.PAccount1.source_to_verityTx", "status": "lean_checked",
     "axioms": ["propext", "Quot.sound"]},
    {"name": "Guarantees.PAddress1.abstract_address_equivariance",
