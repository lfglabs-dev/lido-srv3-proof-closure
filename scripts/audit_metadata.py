...
R1_REVIEW_BASE = "57db8858ec66c3bec11908385286a9341ea9b1ee"
...
R1_REPORT_INPUT_SHA256 = {
    "audit/guarantees.yaml": "f4ca0f465392743dcb62c062d91b2e31c3031b2a57e634b4c0de30fae9a9268f",
...
EXPECTED_CANONICAL_CLAIMS = {
    ...
    "P-DEPOSIT-1": ("CHECKED", "LidoSRv3.Audit.Guarantees.PDeposit1.source_deposit_conserves_and_rolls_back", "CHECKED", "LidoSRv3.Audit.Guarantees.PDeposit1.NFrame.verity_tx_composes_nframe_deposit", "IMPLEMENTATION_PENDING", ("A-ABSTRACT-TX", "A-SOURCE-SHAPED", "A-VERITY-SCAFFOLD", "A-DEPOSIT-32-ETHER", "A-SOLC-TRUSTED", "A-RUNTIME-PROVENANCE")),
