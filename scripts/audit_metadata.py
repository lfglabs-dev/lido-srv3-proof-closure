...
EXPECTED_WORDING = [
    ...
    "Per-validator top-up headroom and aggregate budget conservation are proved at MODEL, SOURCE, and bounded Verity transaction planes, conditional on independently supplied runtime provenance; EVM verifier-binding remains BLOCKED.",
...
EXPECTED_NEXT_GATES = [
    ...
    "Obtain independent canonical runtime, codehash, fork, and address provenance, then refine the conditional source/Verity boundary through Yul and EVM semantics.",
