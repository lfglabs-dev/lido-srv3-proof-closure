...
EXPECTED_CANONICAL_CLAIMS = {
    ...
    "P-DEPOSIT-1": ("CHECKED", "LidoSRv3.Audit.Guarantees.PDeposit1.source_deposit_conserves_and_rolls_back", "CHECKED", "LidoSRv3.Audit.Guarantees.PDeposit1.verity_tx_simulates_deposit_push", "NONE", ("A-SOURCE-SHAPED", "A-VERITY-SCAFFOLD")),
