...
CLAIMS = {
    "P-DEPOSIT-1": {
        ...
        "verity_theorem": "LidoSRv3.Audit.Guarantees.PDeposit1.verity_tx_composes_nframe_deposit",
        "module": "PDeposit1",
        ...
        "declarations": (
            ...
            ("abbrev", "NInputs"),
            ("abbrev", "NPreconditions"),
            ("structure", "LinksSourceN"),
            ("theorem", "fold_amounts_of_per_key"),
            ...
            ("def", "nframeCanonicalSourceInput"),
