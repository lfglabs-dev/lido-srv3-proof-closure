// Compile an inherited pinned ERC721 queue harness into a new evidence directory.
...
const entries=['solidity/trio-reserve1/QueueFinalizeHarness.sol'];
...
console.log('Compiled inherited pinned ERC721 queue with solc '+solc.version());
