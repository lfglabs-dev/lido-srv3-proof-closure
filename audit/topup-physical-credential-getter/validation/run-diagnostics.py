...
with tempfile.TemporaryDirectory(prefix='lido-topup-physical-credential-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/topup-physical-credential-getter/validation/diagnostics.lean'])
