...
with tempfile.TemporaryDirectory(prefix='lido-topup-router-locator-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/topup-router-locator-call/validation/diagnostics.lean'])
