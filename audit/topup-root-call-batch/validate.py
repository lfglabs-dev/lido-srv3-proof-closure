...
MODULES = [
    'LidoSRv3.Audit.Source.TopupGatewayRootCalls',
    'LidoSRv3.Audit.Source.TopupBatchRootCalls',
    'LidoSRv3.Audit.Guarantees.PTopup2RootCalls',
...
for module, path in sorted(sources.items()):
    ...
    if '/.lake/packages/' in absolute:
        ...
        if relpath not in NEW:
            assert git(ROOT, 'show', 'ea5774a82facf0d474e68058c4645ebf4380d403:' + relpath) == data, relpath
        local = True
