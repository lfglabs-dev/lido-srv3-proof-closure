...
| `P-TOPUP-2` | CHECKED | PARTIAL | single Contract.run composition of storage and calls; target/kind/calldata/per-validator granularity; same-run failed-call witness membership | IMPLEMENTATION_PENDING | — |
