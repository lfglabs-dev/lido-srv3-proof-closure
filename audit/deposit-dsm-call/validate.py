...
BASE='9383467fe19c621cc5c37ea54e1d5585b9ba49ee'
MODULE='LidoSRv3.Tests.DepositDsmCall'
NEW=['LidoSRv3/Audit/Source/DepositDsmCall.lean','LidoSRv3/Audit/Guarantees/PDeposit1DsmCall.lean','LidoSRv3/Tests/DepositDsmCall.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.DepositDsmCall.'+name
 names.append(name)
