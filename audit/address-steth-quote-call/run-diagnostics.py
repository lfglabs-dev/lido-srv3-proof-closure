...
with tempfile.TemporaryDirectory(prefix='lido-address-steth-quote-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-steth-quote-call/diagnostics.lean'])
