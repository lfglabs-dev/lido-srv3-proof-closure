...
BASE='6e87eb6e7d6465936d3fab76c3fc7fab5ec51194'
MODULE='LidoSRv3.Tests.AddressStETHQuoteCalls'
NEW=['LidoSRv3/Audit/Source/AddressStETHQuoteCalls.lean','LidoSRv3/Audit/Guarantees/PAddress1StETHQuoteCalls.lean','LidoSRv3/Tests/AddressStETHQuoteCalls.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressStETHQuoteCalls.'+name
 names.append(name)
