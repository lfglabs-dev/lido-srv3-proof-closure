...
BASE='10e2b693d00cbbeab65f60cd8964ced87297336a'
MODULE='LidoSRv3.Tests.DepositPhysicalAdmission'
NEW=['LidoSRv3/Audit/Source/DepositPhysicalAdmission.lean','LidoSRv3/Audit/Guarantees/PDeposit1PhysicalAdmission.lean','LidoSRv3/Tests/DepositPhysicalAdmission.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 if name.startswith('actual_'):name='LidoSRv3.Audit.Guarantees.PDeposit1.'+name
 elif name.startswith('public_'):name='LidoSRv3.Tests.DepositPhysicalAdmission.'+name
 names.append(name)
