...
with tempfile.TemporaryDirectory(prefix='lido-address-permit-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-permit-request-calls/diagnostics.lean'])
