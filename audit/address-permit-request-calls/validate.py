...
BASE='274d8cc9aa543aa4aafda84937689676e0839cfe'
MODULE='LidoSRv3.Tests.AddressPermitRequestCalls'
NEW=['LidoSRv3/Audit/Source/AddressPermitRequestCalls.lean','LidoSRv3/Audit/Guarantees/PAddress1PermitRequestCalls.lean','LidoSRv3/Tests/AddressPermitRequestCalls.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressPermitRequestCalls.'+name
 names.append(name)
