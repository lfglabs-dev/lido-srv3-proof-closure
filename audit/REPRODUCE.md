...
- `P-ETH-1a`: `lake build LidoSRv3.Audit.Guarantees.PEth1` — successful abstract stVault return-confinement proof build; source and EVM correspondence remain open
- `P-ETH-1b`: `lake build LidoSRv3.Audit.Guarantees.PEth1` — successful abstract consolidation-fee path-confinement proof build; source and EVM correspondence remain open
