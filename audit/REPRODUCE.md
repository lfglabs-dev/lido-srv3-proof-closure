...
- `P-ALLOC-1`: `lake build LidoSRv3.Audit.Guarantees.PAlloc1 LidoSRv3.Tests.AllocCapacityRegression` — successful canonical checked-Uint256 allocation-capacity and negative-mutant build; proportional amount correspondence remains open
