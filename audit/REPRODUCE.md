...
- `P-ACCOUNT-1`: `lake build LidoSRv3.Audit.Guarantees.PAccount1` — successful MODEL-to-SOURCE-to-VERITY_TX report-before-reward correspondence and checked-Uint256 refinement build; Yul/EVM/runtime/crypto/E2E remain open
