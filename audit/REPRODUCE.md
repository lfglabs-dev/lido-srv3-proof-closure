...
- `P-ACCOUNT-1`: `lake build LidoSRv3.Audit.Guarantees.PAccount1 LidoSRv3.Tests.AccountingVectors` — successful MODEL/SOURCE ordering and checked-word accumulation evidence only; TX intentionally remains BLOCKED until a distinct stateful execution is proved
