...
- `P-ETH-1`: `lake build LidoSRv3.Audit.Guarantees.PEth1 LidoSRv3.Tests.EthFlowMutants` — successful pinned-source value conservation, destination confinement, executable Verity success/rollback refinement, and negative mutants
