...
- `P-ETH-1`: `lake build LidoSRv3.Audit.Guarantees.PEth1 LidoSRv3.Tests.EthFlowMutants` — successful bounded consolidation-route proofs and mutants only; parent P-ETH-1 remains OPEN
