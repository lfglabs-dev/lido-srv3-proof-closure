...
- `P-ALLOC-1`: `lake build LidoSRv3.Audit.Guarantees.PAlloc1 LidoSRv3.Tests.AllocCapacityRegression` — successful checked-source/capacity correspondence plus bounded official Verity Contract.run conservation refinement, positive receipt, and sensitive overwrite/capacity/disabled mutants; general proportional allocation and Yul/EVM/runtime/deployment remain open
