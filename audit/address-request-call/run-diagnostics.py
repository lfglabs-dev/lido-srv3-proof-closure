...
with tempfile.TemporaryDirectory(prefix='lido-address-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-request-call/diagnostics.lean'])
