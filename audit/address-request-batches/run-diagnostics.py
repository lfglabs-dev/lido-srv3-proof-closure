...
with tempfile.TemporaryDirectory(prefix='lido-address-batches-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-request-batches/diagnostics.lean'])
