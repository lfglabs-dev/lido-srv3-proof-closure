...
BASE='ae30a086154dc78196034657953b9a09cc75b48b'
MODULE='LidoSRv3.Tests.AddressRequestBatches'
NEW=['LidoSRv3/Audit/Source/AddressRequestBatches.lean','LidoSRv3/Audit/Guarantees/PAddress1RequestBatches.lean','LidoSRv3/Tests/AddressRequestBatches.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressRequestBatches.'+name
 names.append(name)
