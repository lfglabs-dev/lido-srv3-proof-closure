...
with tempfile.TemporaryDirectory(prefix='lido-consolidation-entry-runtime-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/consolidation-physical-entry/validation/diagnostics.lean'])
