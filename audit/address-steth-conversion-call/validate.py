...
BASE='ee24f9dc158ed25cec118a8ab8cd3a4fc59942f1'
MODULE='LidoSRv3.Tests.AddressStETHConversionCalls'
NEW=['LidoSRv3/Audit/Source/AddressStETHConversionCalls.lean','LidoSRv3/Audit/Guarantees/PAddress1StETHConversionCalls.lean','LidoSRv3/Tests/AddressStETHConversionCalls.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressStETHConversionCalls.'+name
 names.append(name)
