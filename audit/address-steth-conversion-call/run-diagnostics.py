...
with tempfile.TemporaryDirectory(prefix='lido-address-steth-conversion-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-steth-conversion-call/diagnostics.lean'])
