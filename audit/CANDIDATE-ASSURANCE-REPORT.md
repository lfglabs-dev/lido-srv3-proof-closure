...
- _verifyValidator / 0x02 module WC / block-distance / RootPrecedesLastTopUp (the same-block accumulation half is closed on the actual consumer by PTopup2SameBlock since 2026-09-18, under minBlockDistance ≥ 1, a nonzero uint32 block and the ConfigStable callee premise — see covered; the historical grok #409 model bound is retained).
