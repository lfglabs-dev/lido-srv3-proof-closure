...
- ALLOCATION-VIEWS: the source LIDO.getDepositableEther and module-allocation view producers at StakingRouter.sol:697-700 are omitted. Input.allocation is an arbitrary upstream word; the physical cap/rounding bound holds for it, but does not derive its actual source value or prior view-call failures.
...
**Next gate.** Targeted actual TOPUP build passed at62008e7d34602b1b40fa0f716a63bc3a59a26257, jobf35d5eca-6c18-4e37-af6b-2bc3d934ac0d on dgx-spark, exit0 (1390 jobs). Then continue sequential ALLOC/RESERVE/SSZ review and combined-SHA validation for fresh independent audit.
