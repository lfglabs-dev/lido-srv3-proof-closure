...
**Assumptions.** `A-ABSTRACT-TX`, `A-SOURCE-SHAPED`, `A-VERITY-SCAFFOLD`, `A-SOLC-TRUSTED`, `A-RUNTIME-PROVENANCE`, `A-NO-REENTRY`, `A-SHA256-FFI`, `A-EIP4788-AUTHENTIC`
...
- Global live-state equivariance (NARROWED, not closed): balances and code are fixed, not renamed, and recipient-callee equivariance is supplied. PAddress1LiveRenaming.runClaimWithdrawalsTo_rename proves claim-batch commutation only given an abstract LiveRenaming and an equivariant callee. No concrete LiveRenaming instance or theorem characterizing its existence from keccak-slot collision freedom is supplied. Arbitrary live-world renaming and the other live writers remain future work.
...
**Assumptions.** `A-SOURCE-SHAPED`, `A-VERITY-SCAFFOLD`, `A-SOLC-TRUSTED`, `A-RUNTIME-PROVENANCE`, `A-SHA256-FFI`, `A-EIP4788-AUTHENTIC`
...
**Assumptions.** `A-SHA256-FFI`, `A-MULTI-NODE-TRANSPORT`, `A-SOLC-TRUSTED`, `A-RUNTIME-PROVENANCE`, `A-EIP4788-AUTHENTIC`
