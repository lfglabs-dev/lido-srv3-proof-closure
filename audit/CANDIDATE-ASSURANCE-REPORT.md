...
- LEGACY-RESULT-BRIDGE: bindLiveAll hoists calls and reads model-local cells; the physical producer interleaves checked arithmetic and account-qualified reads. The registered parent now also consumes VerityParentResult.execute through library ABI and final conversion, but does not equate legacy observations with that physical result. AccountProducer.legacy_commits_while_physical_reverts refutes equality under only the old length/binding premises. A derived representation relation and trace-sensitive executor correspondence remain required, not assumed.
...
- DEPLOYMENT: bind the linked library target, deployed runtime and compiler configuration to the executed proportional implementation. The source-level closed-library interpreter does not prove arbitrary deployed code implements it. These obligations remain in scope and open.
...
LidoSRv3.Tests.ConsolidationTxMutants.double_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_1
LidoSRv3.Tests.ConsolidationTxMutants.double_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_2
LidoSRv3.Tests.ConsolidationTxMutants.double_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_3
LidoSRv3.Tests.ConsolidationTxMutants.double_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_4
LidoSRv3.Tests.ConsolidationTxMutants.double_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_5
LidoSRv3.Tests.ConsolidationTxMutants.double_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_6
LidoSRv3.Tests.ConsolidationTxMutants.journal_value_blind_kill_line_refutes_exact_forwarding_slotFree._native.native_decide.ax_1_1
LidoSRv3.Tests.ConsolidationTxMutants.journal_value_blind_kill_line_refutes_exact_forwarding_slotFree._native.native_decide.ax_1_2
LidoSRv3.Tests.ConsolidationTxMutants.journal_value_blind_kill_line_refutes_exact_forwarding_slotFree._native.native_decide.ax_1_3
LidoSRv3.Tests.ConsolidationTxMutants.journal_value_blind_kill_line_refutes_exact_forwarding_slotFree._native.native_decide.ax_1_4
LidoSRv3.Tests.ConsolidationTxMutants.journal_value_blind_kill_line_refutes_exact_forwarding_slotFree._native.native_decide.ax_1_5
LidoSRv3.Tests.ConsolidationTxMutants.journal_value_blind_kill_line_refutes_exact_forwarding_slotFree._native.native_decide.ax_1_6
LidoSRv3.Tests.ConsolidationTxMutants.journal_value_blind_kill_line_refutes_exact_forwarding_slotFree._native.native_decide.ax_1_7
LidoSRv3.Tests.ConsolidationTxMutants.value_blind_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_1
LidoSRv3.Tests.ConsolidationTxMutants.value_blind_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_2
LidoSRv3.Tests.ConsolidationTxMutants.value_blind_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_3
LidoSRv3.Tests.ConsolidationTxMutants.value_blind_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_4
LidoSRv3.Tests.ConsolidationTxMutants.value_blind_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_5
LidoSRv3.Tests.ConsolidationTxMutants.value_blind_debit_kill_line_refutes_preserves_eth_balance_slotFree._native.native_decide.ax_1_6
