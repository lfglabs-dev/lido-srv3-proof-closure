...
with tempfile.TemporaryDirectory(prefix='lido-topup-credential-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/topup-credential-call/validation/diagnostics.lean'])
