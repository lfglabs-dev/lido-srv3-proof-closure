...
DEST = ROOT.parent / 'temp' / 'alloc2-byte-abi'
...
identity = json.loads((ROOT / 'audit/trio/alloc2/byte-runtime/source-identity.json').read_text())
sources = {}
...
vector_path = 'audit/trio/alloc2/runtime/ByteWordCopyVectors.lean'
sources[vector_path] = (ROOT / vector_path).read_bytes()
