...
modules = [
    ...
    ['Interface', 'Storage', 'Execution', 'Properties', 'CapacitySpec', 'Bytes', 'Memory', 'FirstPass', 'Relational', 'Determinism', 'ShareWriter', 'AdmissionChecks', 'ParameterWriter', 'WriterInvariant', 'EnumerationWriter', 'StringStorage', 'AdmissionWriter', 'AdmissionFacts', 'CallTree', 'AllocationMemory']
