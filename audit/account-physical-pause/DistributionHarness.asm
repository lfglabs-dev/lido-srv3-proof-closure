    /* "src/DistributionHarness.sol":321:1843  contract DistributionHarness {... */
  mstore(0x40, 0xc0)
    /* "src/DistributionHarness.sol":567:656  constructor(ILidoShares lido, ILocatorTreasury locator) {LIDO=lido;LIDO_LOCATOR=locator;} */
  callvalue
  dup1
  iszero
  tag_1
...
tag_2:
  sub(exp(0x02, 0xa0), 0x01)
    /* "src/DistributionHarness.sol":624:633  LIDO=lido */
  swap2
  dup3
  and
  0x80
  mstore
    /* "src/DistributionHarness.sol":634:654  LIDO_LOCATOR=locator */
  and
  0xa0
  mstore
    /* "src/DistributionHarness.sol":321:1843  contract DistributionHarness {... */
...
sub_0: assembly {
    ...
    tag_2:
      ...
      dup1
      revert
        /* "src/DistributionHarness.sol":843:1090  function mintAndDistribute(uint256 mint,address[] memory recipients,uint256[] memory amounts,uint256 treasury) external {... */
    tag_3:
      tag_7
      tag_8
      calldatasize
    ...
    tag_7:
      stop
        /* "src/DistributionHarness.sol":356:389  ILidoShares public immutable LIDO */
    tag_4:
      tag_11
    ...
    tag_11:
      ...
      swap1
      return
        /* "src/DistributionHarness.sol":395:441  ILocatorTreasury public immutable LIDO_LOCATOR */
    tag_5:
      tag_11
      immutable("0x5bc0457d8881b800fd1bc0d6df907345b3bf287e43a5790ded3d08dbacf9c03a")
      dup2
      jump
        /* "src/DistributionHarness.sol":661:838  function distribute(address[] memory recipients,uint256[] memory amounts,uint256 treasury) external {... */
    tag_6:
      tag_7
      tag_20
      calldatasize
    ...
    tag_20:
      ...
      jump	// in
        /* "src/DistributionHarness.sol":843:1090  function mintAndDistribute(uint256 mint,address[] memory recipients,uint256[] memory amounts,uint256 treasury) external {... */
    tag_10:
        /* "src/DistributionHarness.sol":976:982  mint>0 */
      dup4
      iszero
        /* "src/DistributionHarness.sol":973:1084  if(mint>0) {LIDO.mintShares(address(this),mint); _distributeFee(FeeDistribution(recipients,amounts,treasury));} */
      tag_30
      jumpi
        /* "src/DistributionHarness.sol":985:1020  LIDO.mintShares(address(this),mint) */
      mload(0x40)
      0x528c198a00000000000000000000000000000000000000000000000000000000
      dup2
      mstore
        /* "src/DistributionHarness.sol":1009:1013  this */
      address
        /* "src/DistributionHarness.sol":985:1020  LIDO.mintShares(address(this),mint) */
      0x04
      dup3
      ...
      swap1
      mstore
        /* "src/DistributionHarness.sol":985:989  LIDO */
      immutable("0x77c32b454bb61eb9df9e3848d0ded3e59753acda90ae58befe564733aec82e4c")
      sub(exp(0x02, 0xa0), 0x01)
        /* "src/DistributionHarness.sol":985:1000  LIDO.mintShares */
      and
      swap1
      0x528c198a
      swap1
    ...
    tag_29:
      ...
      pop
      pop
        /* "src/DistributionHarness.sol":1022:1082  _distributeFee(FeeDistribution(recipients,amounts,treasury)) */
      tag_30
        /* "src/DistributionHarness.sol":1037:1081  FeeDistribution(recipients,amounts,treasury) */
      mload(0x40)
      dup1
      0x60
      add
      ...
      mstore
      dup1
        /* "src/DistributionHarness.sol":1053:1063  recipients */
      dup6
        /* "src/DistributionHarness.sol":1037:1081  FeeDistribution(recipients,amounts,treasury) */
      dup2
      mstore
      0x20
      add
        /* "src/DistributionHarness.sol":1064:1071  amounts */
      dup5
        /* "src/DistributionHarness.sol":1037:1081  FeeDistribution(recipients,amounts,treasury) */
      dup2
      mstore
      0x20
      add
        /* "src/DistributionHarness.sol":1072:1080  treasury */
      dup4
        /* "src/DistributionHarness.sol":1037:1081  FeeDistribution(recipients,amounts,treasury) */
      dup2
      mstore
      pop
        /* "src/DistributionHarness.sol":1022:1036  _distributeFee */
      tag_31
        /* "src/DistributionHarness.sol":1022:1082  _distributeFee(FeeDistribution(recipients,amounts,treasury)) */
      jump	// in
    tag_30:
      ...
      jump	// out
        /* "src/DistributionHarness.sol":661:838  function distribute(address[] memory recipients,uint256[] memory amounts,uint256 treasury) external {... */
    tag_22:
        /* "src/DistributionHarness.sol":771:831  _distributeFee(FeeDistribution(recipients,amounts,treasury)) */
      tag_33
        /* "src/DistributionHarness.sol":786:830  FeeDistribution(recipients,amounts,treasury) */
      mload(0x40)
      dup1
      0x60
      add
      ...
      mstore
      dup1
        /* "src/DistributionHarness.sol":802:812  recipients */
      dup6
        /* "src/DistributionHarness.sol":786:830  FeeDistribution(recipients,amounts,treasury) */
      dup2
      mstore
      0x20
      add
        /* "src/DistributionHarness.sol":813:820  amounts */
      dup5
        /* "src/DistributionHarness.sol":786:830  FeeDistribution(recipients,amounts,treasury) */
      dup2
      mstore
      0x20
      add
        /* "src/DistributionHarness.sol":821:829  treasury */
      dup4
        /* "src/DistributionHarness.sol":786:830  FeeDistribution(recipients,amounts,treasury) */
      dup2
      mstore
      pop
        /* "src/DistributionHarness.sol":771:785  _distributeFee */
      tag_31
        /* "src/DistributionHarness.sol":771:831  _distributeFee(FeeDistribution(recipients,amounts,treasury)) */
      jump	// in
    tag_33:
      ...
      pop
      jump	// out
        /* "src/DistributionHarness.sol":1095:1840  function _distributeFee(FeeDistribution memory _feeDistribution) internal {... */
    tag_31:
        /* "src/DistributionHarness.sol":1209:1245  _feeDistribution.moduleFeeRecipients */
      dup1
      mload
        /* "src/DistributionHarness.sol":1287:1322  _feeDistribution.moduleSharesToMint */
      0x20
      dup3
      add
      mload
        /* "src/DistributionHarness.sol":1349:1366  recipients.length */
      dup2
      mload
        /* "src/DistributionHarness.sol":1179:1206  address[] memory recipients */
      0x00
        /* "src/DistributionHarness.sol":1377:1589  for (uint256 i; i < length; ++i) {... */
    tag_35:
        /* "src/DistributionHarness.sol":1397:1403  length */
      dup2
        /* "src/DistributionHarness.sol":1393:1394  i */
      dup2
        /* "src/DistributionHarness.sol":1393:1403  i < length */
      lt
        /* "src/DistributionHarness.sol":1377:1589  for (uint256 i; i < length; ++i) {... */
      iszero
      tag_36
      jumpi
        /* "src/DistributionHarness.sol":1424:1444  uint256 moduleShares */
      0x00
        /* "src/DistributionHarness.sol":1447:1459  sharesToMint */
      dup4
        /* "src/DistributionHarness.sol":1460:1461  i */
      dup3
        /* "src/DistributionHarness.sol":1447:1462  sharesToMint[i] */
      dup2
      mload
      dup2
      lt
    ...
    tag_39:
      ...
      add
      mload
        /* "src/DistributionHarness.sol":1424:1462  uint256 moduleShares = sharesToMint[i] */
      swap1
      pop
        /* "src/DistributionHarness.sol":1495:1496  0 */
      0x00
        /* "src/DistributionHarness.sol":1480:1492  moduleShares */
      dup2
        /* "src/DistributionHarness.sol":1480:1496  moduleShares > 0 */
      gt
        /* "src/DistributionHarness.sol":1476:1579  if (moduleShares > 0) {... */
      iszero
      tag_41
      jumpi
        /* "src/DistributionHarness.sol":1516:1520  LIDO */
      immutable("0x77c32b454bb61eb9df9e3848d0ded3e59753acda90ae58befe564733aec82e4c")
      sub(exp(0x02, 0xa0), 0x01)
        /* "src/DistributionHarness.sol":1516:1535  LIDO.transferShares */
      and
      0x8fcb4e5b
        /* "src/DistributionHarness.sol":1536:1546  recipients */
      dup7
        /* "src/DistributionHarness.sol":1547:1548  i */
      dup5
        /* "src/DistributionHarness.sol":1536:1549  recipients[i] */
      dup2
      mload
      dup2
      lt
    ...
    tag_43:
      ...
      add
      mload
        /* "src/DistributionHarness.sol":1551:1563  moduleShares */
      dup4
        /* "src/DistributionHarness.sol":1516:1564  LIDO.transferShares(recipients[i], moduleShares) */
      mload(0x40)
      dup4
      0xffffffff
      and
    ...
    tag_41:
      pop
        /* "src/DistributionHarness.sol":1405:1408  ++i */
      tag_50
      dup2
      tag_51
      jump	// in
    ...
    tag_36:
      pop
        /* "src/DistributionHarness.sol":1624:1661  _feeDistribution.treasurySharesToMint */
      0x40
      dup5
      add
      mload
        /* "src/DistributionHarness.sol":1675:1693  treasuryShares > 0 */
      dup1
      iszero
        /* "src/DistributionHarness.sol":1671:1834  if (treasuryShares > 0) { // zero is an edge case when all fees goes to modules... */
      tag_52
      jumpi
        /* "src/DistributionHarness.sol":1763:1767  LIDO */
      immutable("0x77c32b454bb61eb9df9e3848d0ded3e59753acda90ae58befe564733aec82e4c")
      sub(exp(0x02, 0xa0), 0x01)
        /* "src/DistributionHarness.sol":1763:1782  LIDO.transferShares */
      and
      0x8fcb4e5b
        /* "src/DistributionHarness.sol":1783:1795  LIDO_LOCATOR */
      immutable("0x5bc0457d8881b800fd1bc0d6df907345b3bf287e43a5790ded3d08dbacf9c03a")
      sub(exp(0x02, 0xa0), 0x01)
        /* "src/DistributionHarness.sol":1783:1804  LIDO_LOCATOR.treasury */
      and
      0x61d027b3
        /* "src/DistributionHarness.sol":1783:1806  LIDO_LOCATOR.treasury() */
      mload(0x40)
      dup2
      0xffffffff
      and
    ...
    tag_55:
      ...
      jump	// in
    tag_56:
        /* "src/DistributionHarness.sol":1763:1823  LIDO.transferShares(LIDO_LOCATOR.treasury(), treasuryShares) */
      mload(0x40)
      exp(0x02, 0xe0)
      0xffffffff
      dup5
    ...
    tag_62:
      pop
        /* "src/DistributionHarness.sol":1671:1834  if (treasuryShares > 0) { // zero is an edge case when all fees goes to modules... */
    tag_52:
        /* "src/DistributionHarness.sol":1169:1840  {... */
      pop
      pop
      pop
      pop
    ...
    auxdata: 0xa2646970667358221220fe1f045addab99dfad6dff4b56dc71eb4f8800161c8576f1de9a2740cf2e44b064736f6c63430008090033
}
