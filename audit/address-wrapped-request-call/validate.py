...
BASE='f9f5639bdcc30a5f653fe679c9caba306a84df19'
MODULE='LidoSRv3.Tests.AddressWrappedRequestCalls'
NEW=['LidoSRv3/Audit/Source/AddressWrappedRequestCalls.lean','LidoSRv3/Audit/Guarantees/PAddress1WrappedRequestCalls.lean','LidoSRv3/Tests/AddressWrappedRequestCalls.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressWrappedRequestCalls.'+name
 names.append(name)
