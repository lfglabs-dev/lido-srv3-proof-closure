...
with tempfile.TemporaryDirectory(prefix='lido-address-wrapped-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-wrapped-request-call/diagnostics.lean'])
