...
BASE='107e57e53ad4b1bd459a062d887bbcac85be6e41'
MODULE='LidoSRv3.Tests.AddressStETHTransferCalls'
NEW=['LidoSRv3/Audit/Source/AddressStETHTransferCalls.lean','LidoSRv3/Audit/Guarantees/PAddress1StETHTransferCalls.lean','LidoSRv3/Tests/AddressStETHTransferCalls.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressStETHTransferCalls.'+name
 names.append(name)
