...
MODULE='LidoSRv3.Tests.AddressWrappedTokenCalls'
NEW=['LidoSRv3/Audit/Source/AddressWrappedTokenCalls.lean','LidoSRv3/Audit/Guarantees/PAddress1WrappedTokenCalls.lean','LidoSRv3/Tests/AddressWrappedTokenCalls.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressWrappedTokenCalls.'+name
 names.append(name)
