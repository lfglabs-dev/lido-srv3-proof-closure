...
with tempfile.TemporaryDirectory(prefix='lido-address-token-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-wrapped-token-call/diagnostics.lean'])
