...
with tempfile.TemporaryDirectory(prefix='lido-address-steth-transfer-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-steth-transfer-from-call/diagnostics.lean'])
