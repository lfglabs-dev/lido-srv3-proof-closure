...
- `P-TOPUP-1` — **IMPLEMENTATION_PENDING**: Preserve the four surgical abstract-plane kill-lines, wrap-precludes-value-moving-commit (including wrap-to-zero empty commit), and the Verity correspondence without a NoUncheckedWrap hypothesis; remaining gap is beacon-address provenance, not ALLOC composition.
