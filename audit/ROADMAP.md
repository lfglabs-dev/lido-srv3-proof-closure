...
- `P-ETH-1` — **IMPLEMENTATION_PENDING**: Compose into P-CONSOLIDATION-1 only after an ABI/interpreter bridge relates live grouped addConsolidationRequests execution to this CallProgram model.
