...
- `P-TOPUP-1` — **IMPLEMENTATION_PENDING**: Preserve the four surgical abstract-plane kill-lines and the no-wrap Verity correspondence; remaining gaps are residual exact-reading guards, the Verity wrap-branch hypothesis, and beacon-address provenance, not ALLOC composition.
