...
with tempfile.TemporaryDirectory(prefix='lido-address-transfer-ffi-') as directory:
    ...
    run(['lake','env','lean','--load-dynlib='+str(lib),'audit/address-wrapped-transfer-call/diagnostics.lean'])
