...
MODULE='LidoSRv3.Tests.AddressWrappedTransferCalls'
NEW=['LidoSRv3/Audit/Source/AddressWrappedTransferCalls.lean','LidoSRv3/Audit/Guarantees/PAddress1WrappedTransferCalls.lean','LidoSRv3/Tests/AddressWrappedTransferCalls.lean']
...
for name in re.findall(r'^#print axioms (\S+)',(ROOT/NEW[-1]).read_text(),re.M):
 ...
 elif name.startswith('public_'):name='LidoSRv3.Tests.AddressWrappedTransferCalls.'+name
 names.append(name)
