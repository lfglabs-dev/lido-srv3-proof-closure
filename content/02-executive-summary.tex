...
report package shows the intended final-report answer once the companion proof
...
repository is a report package, that sentence is the evidence threshold for a real
...
\smallskip
\noindent The final claim this report package is designed to support is:
...
\noindent All six rows below are targets: they show the intended final
